  ...
  return (
    <>
      ...
      <section className="bg-white">
              ...
              <table className="table-fixed w-full text-sm text-left text-gray-500 ">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 ">
                  <tr>
                    <th
                      scope="col"
                      className="w-3/4 text-lg px-6 py-3 text-center"
                    >
                      제목
                    </th>
                    <th
                      scope="col"
                      className="w-1/4px-6 text-lg py-3 text-center"
                    >
                      게시일
                    </th>
                  </tr>
                      ...
                      <tr key={index} className=" bg-white border-b">
                        ...
                        >
                          <a target="_blank" href={elem.url}>
                            <p className="whitespace-normal text-lg font-bold line-clamp-2">
                              {elem.title}
                            </p>
                          </a>
                          <p className="text-base font-bold whitespace-normal line-clamp-2 text-left text-gray-700">
                            {elem.subtitle}
                          </p>
              ...
              <table className="table-fixed w-full text-sm text-left text-gray-500 ">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 ">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="w-1/4 text-lg px-6 py-3 text-center"
                    >
                      게시일
                    </th>
                  </tr>
        ...
        <div className="flex flex-col my-10 text-lg px-14 lg:px-0">

                    ...
                    presidentbrief.map((elem,index)=>{
                      return(
                        <tr key={index} className=" bg-white border-b ">
                          ...
                          <a target='_blank' href={elem.url}><p className='whitespace-normal font-bold line-clamp-2'>{elem.title}</p></a>
                ...
                <tbody>
                  {
                    presidentNBS.map((elem,index)=>{
                      return(
                        <tr key={index} className=" bg-white border-b ">
                          <th scope="row" className="grid-cols-2 px-6 py-4 text-gray-900 whitespace-nowrap ">
                              <p className='font-bold whitespace-normal line-clamp-2'><a target="_blank" href={elem.url}>{elem.title}</a></p>
